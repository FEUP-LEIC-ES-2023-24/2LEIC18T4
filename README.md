...
- Map with real-time user location, showing the best places to study in the Porto metropolitan area.
- Limited access to the app as a guest, or full access to all features when logged in with an account.
- Profile customization.
- App color palette adapts to the user's faculty.
- Collect medals as you visit more places around Porto!
- Save your favorite places on your Starred page.
- Rate and review the places you visit, and see ratings and comments from other users.
